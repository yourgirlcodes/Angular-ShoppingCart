var SourceMapConsumer = require("@cspotcode/source-map-consumer")
  .SourceMapConsumer;
...
exports.install = function (options) {
  ...
  if (redirectConflictingLibrary) {
    if (!sharedData.moduleResolveFilenameHook) {
      ...
      Module._resolveFilename = sharedData.moduleResolveFilenameHook.installedValue = function (
        request,
        parent,
        isMain,
        options
  ...
  if (!sharedData.errorPrepareStackTraceHook) {
    ...
    Error.prepareStackTrace = sharedData.errorPrepareStackTraceHook.installedValue = createPrepareStackTrace(
      sharedData.errorPrepareStackTraceHook
    );
  }
